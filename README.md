...
The 20 most recent merged PRs. This list is generated from GitHub and refreshes daily. Last updated: 2026-05-30.

<!-- recent-contributions:start -->

| Contribution | What changed | Creator |
| ------------ | ------------ | ------- |
| [Add Edge Function deploy + schema-change guard workflows](.github/workflows/deploy-edge-functions.yml) | Adds Edge Function deploy + schema-change guard workflows. | [@msykes](https://github.com/msykes) |
